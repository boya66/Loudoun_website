...
Loudon County is part of the northern Virginia region. Along with Loudon County, NOVA also consists of:
...
```
```{r plot, echo=FALSE, fig.height = 6, fig.width = 10, fig.align = "center", eval=FALSE}
ggplot(map_and_data) + 
...
```
![](/knitted_demographics_loudon_files/figure-html/plot-1.png){style="width:75%; display: block; margin-left: auto; margin-right: auto;"}
