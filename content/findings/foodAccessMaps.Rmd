...
where $A_{i}$ is accessibility index for each census tract $i$, $dist_{i,j}$ is the distance from the population weighted centroid for each census tract $i$ to each food supply source $j$, and $pop_i$ is the population for each census tract $i$.
