...
```{r Food Retailer Plot 1, eval = TRUE, echo=FALSE, fig.height = 6, fig.width = 7, fig.align = "center"}
...
```{r Food Pantry Plot 2, eval = TRUE,  echo=FALSE, fig.height = 6, fig.width = 7, fig.align = "center"}
...
```{r Food Market Plot 3, eval = TRUE,  echo=FALSE, fig.height = 6, fig.width = 7, fig.align = "center"}
# Map of inverse distance of retailers within radius
